  ...
  "@graph": [
    {
      "@type": "Organization",
      name: "Enact",
      url: "https://www.enact.ai",
      sameAs: ["https://github.com/enact-ai/enact"],
    },
    {
...
export default async function LandingLayout({
  ...
  return (
    <>
      ...
      />
      <div className={`${instrumentSerif.variable} enact-fixed-light landing-light h-full overflow-x-hidden overflow-y-auto bg-white`}>
