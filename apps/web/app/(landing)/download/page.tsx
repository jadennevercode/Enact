...
export const metadata: Metadata = {
  title: "Download Enact",
  description:
    "Download Enact for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Enact",
    description:
      "Get the Enact desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
