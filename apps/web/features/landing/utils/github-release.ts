...
/**
 * Server-side fetcher for the latest downloadable Enact release,
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/enact-ai/enact/releases?per_page=5";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Enact doesn't publish prereleases or drafts
