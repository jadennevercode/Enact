...
function completeAssets(version: string) {
  return [
    `enact-desktop-${version}-mac-arm64.dmg`,
    `enact-desktop-${version}-mac-arm64.zip`,
    `enact-desktop-${version}-mac-x64.dmg`,
    `enact-desktop-${version}-mac-x64.zip`,
    `enact-desktop-${version}-windows-x64.exe`,
    `enact-desktop-${version}-windows-arm64.exe`,
    `enact-desktop-${version}-linux-x86_64.AppImage`,
    `enact-desktop-${version}-linux-amd64.deb`,
    `enact-desktop-${version}-linux-x86_64.rpm`,
    `enact-desktop-${version}-linux-arm64.AppImage`,
    `enact-desktop-${version}-linux-arm64.deb`,
    `enact-desktop-${version}-linux-aarch64.rpm`,
  ].map((name) => ({
    name,
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/enact-ai/enact/releases/tag/${overrides.tag}`,
