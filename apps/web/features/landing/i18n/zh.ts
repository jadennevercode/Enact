...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    headlineLine2: "\u4e0d\u662f\u4eba\u7c7b\u3002",
    subheading:
      "Enact \u662f\u4e00\u4e2a\u5f00\u6e90\u5e73\u53f0\uff0c\u5c06\u7f16\u7801 智能体 \u53d8\u6210\u771f\u6b63\u7684\u961f\u53cb\u3002\u5206\u914d\u4efb\u52a1\u3001\u8ddf\u8e2a\u8fdb\u5ea6\u3001\u79ef\u7d2f\u6280\u80fd\u2014\u2014\u5728\u4e00\u4e2a\u5730\u65b9\u7ba1\u7406\u4f60\u7684\u4eba\u7c7b + 智能体 \u56e2\u961f\u3002",
    cta: "免费开始",
    downloadDesktop: "下载桌面端",
    talkToSales: "联系商务",
    worksWith: "支持",
    imageAlt: "Enact \u770b\u677f\u89c6\u56fe\u2014\u2014\u4eba\u7c7b\u548c 智能体 \u534f\u540c\u7ba1\u7406\u4efb\u52a1",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          title: "\u9996\u6b21\u542f\u52a8\u81ea\u52a8\u6ce8\u518c",
          description:
            "Enact \u626b\u63cf\u672c\u673a\u7684 23 \u6b3e\u652f\u6301\u7684 AI \u7f16\u7a0b\u5de5\u5177\u2014\u2014Antigravity\u3001Claude Code\u3001CodeBuddy\u3001Codex\u3001Copilot\u3001Cursor\u3001DeepSeek Harness\u3001DevEco Code\u3001Dim\u3001Grok\u3001Hermes\u3001Kimi\u3001Kiro CLI\u3001Oh-My-Pi\u3001OpenClaw\u3001OpenCode\u3001Pi\u3001Qoder\u3001Qoder CN\u3001Qwen Code\u3001QwenPaw\u3001Reasonix\u3001Trae CLI\u2014\u2014\u5e76\u4e3a\u6bcf\u6b3e\u5df2\u5b89\u88c5\u7684\u5de5\u5177\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "运行 enact setup——它会引导你完成 OAuth 登录、启动守护进程、并扫描 23 款支持的 AI 编程工具（Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI）。本机已安装的工具会被自动注册成运行时。",
      },
      {
        title: "\u521b\u5efa\u4f60\u7684\u7b2c\u4e00\u4e2a 智能体",
        description:
  ...
  openSource: {
    ...
    headlineLine2: "\u4e3a\u6240\u6709\u4eba\u3002",
    description:
      "Enact \u5b8c\u5168\u5f00\u6e90\u3002\u5ba1\u67e5\u6bcf\u4e00\u884c\u4ee3\u7801\uff0c\u6309\u4f60\u7684\u65b9\u5f0f\u81ea\u6258\u7ba1\uff0c\u5851\u9020\u4eba\u7c7b + 智能体 \u534f\u4f5c\u7684\u672a\u6765\u3002",
    cta: "\u5728 GitHub \u4e0a Star",
    highlights: [
      {
        title: "\u968f\u5904\u81ea\u6258\u7ba1",
        description:
          "\u5728\u4f60\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u8fd0\u884c Enact\u3002Docker Compose\u3001\u5355\u4e2a\u4e8c\u8fdb\u5236\u6216 Kubernetes\u2014\u2014\u4f60\u7684\u6570\u636e\u6c38\u8fdc\u4e0d\u4f1a\u79bb\u5f00\u4f60\u7684\u7f51\u7edc\u3002",
      },
      {
        title: "\u65e0\u4f9b\u5e94\u5546\u9501\u5b9a",
        description:
  ...
  faq: {
    ...
    items: [
      {
        question: "Enact \u652f\u6301\u54ea\u4e9b\u7f16\u7801 智能体\uff1f",
        answer:
          "Enact \u5f00\u7bb1\u5373\u7528\u652f\u6301 23 \u6b3e AI \u7f16\u7a0b\u5de5\u5177\uff1aAntigravity\u3001Claude Code\u3001CodeBuddy\u3001Codex\u3001Copilot\u3001Cursor\u3001DeepSeek Harness\u3001DevEco Code\u3001Dim\u3001Grok\u3001Hermes\u3001Kimi\u3001Kiro CLI\u3001Oh-My-Pi\u3001OpenClaw\u3001OpenCode\u3001Pi\u3001Qoder\u3001Qoder CN\u3001Qwen Code\u3001QwenPaw\u3001Reasonix\u3001Trae CLI\u3002\u5b88\u62a4\u8fdb\u7a0b\u4f1a\u81ea\u52a8\u68c0\u6d4b\u672c\u673a\u5df2\u5b89\u88c5\u7684 CLI \u5e76\u4e3a\u6bcf\u6b3e\u6ce8\u518c\u4e00\u4e2a\u8fd0\u884c\u65f6\u3002\u56e0\u4e3a\u5f00\u6e90\uff0c\u4f60\u4e5f\u53ef\u4ee5\u81ea\u5df1\u6dfb\u52a0\u540e\u7aef\u3002",
      },
      {
        question: "\u9700\u8981\u81ea\u6258\u7ba1\u5417\uff0c\u8fd8\u662f\u6709\u4e91\u7248\u672c\uff1f",
        answer:
          "\u4e24\u8005\u90fd\u6709\u3002\u4f60\u53ef\u4ee5\u7528 Docker Compose \u6216 Kubernetes \u5728\u81ea\u5df1\u7684\u57fa\u7840\u8bbe\u65bd\u4e0a\u81ea\u6258\u7ba1 Enact\uff0c\u4e5f\u53ef\u4ee5\u4f7f\u7528\u6211\u4eec\u7684\u6258\u7ba1\u4e91\u7248\u672c\u3002\u4f60\u7684\u6570\u636e\uff0c\u4f60\u9009\u62e9\u3002",
      },
      {
        question:
          "\u8fd9\u548c\u76f4\u63a5\u7528\u7f16\u7801 智能体 \u6709\u4ec0\u4e48\u533a\u522b\uff1f",
        answer:
          "\u7f16\u7801 智能体 \u64c5\u957f\u6267\u884c\u3002Enact \u6dfb\u52a0\u7684\u662f\u7ba1\u7406\u5c42\uff1a\u4efb\u52a1\u961f\u5217\u3001\u56e2\u961f\u534f\u4f5c\u3001\u6280\u80fd\u590d\u7528\u3001\u8fd0\u884c\u65f6\u76d1\u63a7\uff0c\u4ee5\u53ca\u6bcf\u4e2a 智能体 \u5728\u505a\u4ec0\u4e48\u7684\u7edf\u4e00\u89c6\u56fe\u3002\u628a\u5b83\u60f3\u8c61\u6210\u4f60\u7684 智能体 \u7684\u9879\u76ee\u7ecf\u7406\u3002",
      },
      {
        question: "智能体 \u80fd\u81ea\u4e3b\u5904\u7406\u957f\u65f6\u95f4\u4efb\u52a1\u5417\uff1f",
        answer:
          "\u53ef\u4ee5\u3002Enact \u7ba1\u7406\u5b8c\u6574\u7684\u4efb\u52a1\u751f\u547d\u5468\u671f\u2014\u2014\u5165\u961f\u3001\u9886\u53d6\u3001\u6267\u884c\u3001\u5b8c\u6210\u6216\u5931\u8d25\u3002智能体 \u4e3b\u52a8\u62a5\u544a\u963b\u585e\u5e76\u5b9e\u65f6\u63a8\u9001\u8fdb\u5ea6\u3002\u4f60\u53ef\u4ee5\u968f\u65f6\u67e5\u770b\uff0c\u4e5f\u53ef\u4ee5\u8ba9\u5b83\u4eec\u8fd0\u884c\u6574\u665a\u3002",
      },
      {
        question: "\u6211\u7684\u4ee3\u7801\u5b89\u5168\u5417\uff1f智能体 \u5728\u54ea\u91cc\u6267\u884c\uff1f",
        answer:
          "智能体 \u5728\u4f60\u7684\u673a\u5668\uff08\u672c\u5730\u5b88\u62a4\u8fdb\u7a0b\uff09\u6216\u4f60\u81ea\u5df1\u7684\u4e91\u57fa\u7840\u8bbe\u65bd\u4e0a\u6267\u884c\u3002\u4ee3\u7801\u6c38\u8fdc\u4e0d\u4f1a\u7ecf\u8fc7 Enact \u670d\u52a1\u5668\u3002\u5e73\u53f0\u53ea\u534f\u8c03\u4efb\u52a1\u72b6\u6001\u548c\u5e7f\u64ad\u4e8b\u4ef6\u3002",
      },
      {
  ...
  changelog: {
    ...
    entries: [
      ...
      },
      {
        ...
        improvements: [
          "`enact daemon logs` 会直接告诉你日志文件在哪。",
      ...
      },
      {
        ...
        features: [
          ...
          "Enact 里的任意链接，Cmd/Ctrl 或中键点击就能在新标签页打开。",
      ...
      },
      {
        ...
        features: [
          ...
          "手动替换 enact 或 Agent CLI 后自动生效，不用重启。",
        ],
        improvements: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Linux 桌面应用现在会以 enact-desktop 的名字安装。",
        ],
      },
      {
        version: "0.4.2",
      ...
      },
      {
        ...
        features: [
          ...
          "输入或粘贴像 ENAC-123 这样的任务编号，它会自动变成可点击的任务链接。",
      ...
      },
      {
        ...
        features: [
          ...
          "自托管（Helm）：新增 `postgres.external.enabled` 开关，可将 Enact 指向外部托管的 PostgreSQL（RDS、CNPG、Cloud SQL、Neon 等），跳过内置数据库。",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Slack 里可以直接用原生 /issue 斜杠命令创建 Enact 任务，机器人只会向你私发一条包含任务链接的确认消息。",
          "同一 Slack 工作区里已经和某个 Enact 机器人绑定过的用户，遇到新加入的第二个机器人时无需再走一次绑定流程。",
        ...
        fixes: [
          ...
          "自托管的 docker-compose.selfhost.yml 现在会把 ENACT_SLACK_SECRET_KEY 透传到后端容器。（社区反馈）",
          "任务面板顶部「N 个任务正在处理中」的胶囊改为按任务数去重。",
          "自托管匿名来源统计的上报地址恢复到正式的 Enact API。",
      ...
      },
      {
        ...
        features: [
          ...
          "Slack 频道可以把过往对话回灌到 Enact，智能体一进入频道即拥有完整上下文。",
          "Slack 智能体处理消息期间会在用户消息上加 👀 反应表情，处理结束后稳定清除，不再出现卡死。",
          "技能包支持从本地 .skill / .zip 归档导入。",
          "enact issue 命令不再接受短 UUID 前缀，请使用任务 Key（ENAC-123）或完整 UUID。",
          "Agents 页面适配移动端。",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "Cursor 和 OpenClaw 更容易配置：Cursor 连接设置可以由 Enact 托管，OpenClaw 也可以连接已有网关",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "CodeBuddy 现在可以驱动本地 Enact 智能体，并会自动显示可用的模型和投入强度选项",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "网页端现在可以显示浏览器原生通知横幅，即使 Enact 在后台，也更容易及时看到工作区动态",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "支持 Lark 第三方集成，扫码就能把 Enact 智能体创建成一个 Lark Bot",
          "聊天现在支持可搜索的智能体选择器和明确的上下文选择器，更容易指定谁来回复、需要看哪些内容",
          "描述和评论现在支持勾选式待办清单，任务里的轻量计划更好整理",
          "智能体现在内置 Enact 技能，可以更稳定地遵循工作区工作流",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "Enact 现在支持韩语界面、官网和文档，包含完整韩语文档与本地化日期显示",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Enact iOS 客户端发布官方首个可用版本，覆盖登录、工作区、收件箱、任务、项目、聊天、评论、表情回应、在线状态和实时更新；目前暂未上架 App Store，需要用户自行打包安装",
          "自托管团队现在可以通过 Helm 将 Enact 部署到 Kubernetes，Docker 安装也有更清晰的端口和 URL 配置",
      ...
      },
      {
        ...
        improvements: [
          ...
          "关联 GitHub 的 Pull Request 会在 Enact 内展示 CI 和合并冲突状态",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "接入 GitHub 后，关联的 Pull Request 会显示在 Enact 任务中，状态会同步到 Enact，关闭 PR 后会自动关闭对应任务",
          "聊天消息支持添加文件附件和图片预览",
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux 桌面端用 Enact asterisk 替换 Electron 默认占位图标",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`enact repo checkout --ref` 支持按分支、tag 或指定 commit 拉取仓库",
          "`enact agent avatar` 命令支持直接通过 CLI 上传 Agent 头像",
        ...
        fixes: [
          ...
          "`enact login --token <PAT>` 正确接收 PAT 作为参数值",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Enact Agent 的 Git 提交自动追加 `Co-authored-by` trailer，归属更清晰",
      ...
      },
      {
        ...
        improvements: [
          ...
          "后端支持通过 `ENACT_CLAUDE_ARGS` / `ENACT_CODEX_ARGS` 配置 Agent CLI 默认参数",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`enact agent create/update --custom-env KEY=VALUE` 支持为 Agent 注入自定义环境变量",
          "Agent 失败信息会带上 Runtime CLI 的 stderr 末尾片段，排查 Runtime 报错更直接",
          "CLI 更新下载超时支持配置，弱网下 `enact update` 不再被默认超时切断",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "新增 `enact update` 自更新命令——无需重装即可升级 CLI 和本地 Daemon",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Agent 新增 `model` 字段及按 Provider 聚合的模型下拉框——可在界面或通过 `enact agent create/update --model` 为每个 Agent 选择 LLM 模型，并从各 Runtime CLI 实时发现可用模型",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "一键安装与配置——`curl | bash` 安装 CLI，`--with-server` 完整自部署，`enact setup` 配置连接环境",
      ...
      },
      {
        ...
        improvements: [
          ...
          "搜索排序优化——大小写无关匹配、标识符搜索（ENAC-123）、多词匹配",
          "搜索结果关键词高亮",
      ...
      },
      {
        ...
        changes: [
          ...
          "重新登录后记住上次选择的工作区",
          "守护进程确保 Agent task 环境中 enact CLI 在 PATH 上",
  ...
  contactSales: {
    pageTitle: "联系商务",
    pageDescription:
      "了解如何在你的团队中落地 Enact 的人类 + 智能体协作工作流。",
    eyebrow: "联系商务",
    title: "先了解你的需求",
    ...
    fields: {
      ...
      companySize: "公司规模",
      countryRegion: "国家 / 地区",
      useCase: "你打算如何使用 Enact 或与我们合作？",
      goals: "你的目标或挑战",
      goalsHint:
        "告诉我们你希望借助 Enact 达成什么目标，或正在面临的挑战。信息越详细，我们越能给到合适的支持。",
    ...
    useCases: [
      { value: "evaluate", label: "正在为团队评估 Enact" },
    ...
    consent: {
      intro:
        "Enact, Inc. 尊重你的隐私。我们仅会将你的个人信息用于管理账户，以及提供你所请求的产品或服务。我们偶尔也希望与你分享产品更新、最佳实践或行业洞察，如果你愿意接收，请在下方勾选。",
      outreach:
        "我希望接收来自 Enact, Inc. 的一对一沟通，包括服务更新、支持咨询以及业务相关的跟进。",
      updates:
        "我希望接收 Enact 的产品更新、洞察以及活动邀请。",
      unsubscribe:
        "你可以随时取消订阅我们的邮件。关于我们如何处理你的数据以及隐私权利，请参阅",
      submitConsent:
        "点击「提交」即表示你同意 Enact, Inc. 存储并处理你提交的信息，以便交付你请求的内容。",
    ...
    success: {
      title: "已收到，谢谢！",
      message:
        "Enact 团队会在三个工作日内回复你。在此期间，欢迎查看我们的文档，或在 GitHub 上为我们点个 Star。",
      cta: "返回首页",
    },
    errors: {
      generic: "提交失败，请稍后再试。",
