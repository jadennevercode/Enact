...
export function createKoDict(allowSignup: boolean): LandingDict {
  ...
  return {
      ...
      steps: [
        {
          ...
          description: allowSignup
            ? "이메일을 입력하면 바로 시작할 수 있습니다. 워크스페이스는 자동으로 만들어지며, 별도의 설정 과정도 없습니다."
            : "이메일을 입력하면 바로 워크스페이스에 들어갈 수 있습니다. 별도의 설정 과정도 없습니다.",
        },
        {
      ...
      entries: [
        ...
        },
        {
          ...
          fixes: [
            ...
            "태스크의 PR 목록에는 실제로 그 태스크를 대상으로 삼는 PR만 표시되고, 본문에서 'Related to ENA-…' 정도로만 언급한 PR은 숨겨집니다.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "로그인 입력칸에 자동으로 포커스되고, 상세 화면을 열 때 사이드바가 의도치 않게 움직이지 않습니다.",
    ...
    about: {
      title: "Enact 소개",
      nameLine: "Enact는 의도를 추적 가능하고 책임 있는 실행으로 바꿉니다.",
      paragraphs: [
        ...
        "Enact는 사람의 판단, 에이전트 실행, 프로젝트 맥락을 하나의 공유 시스템에 모아 작은 팀이 통제력을 잃지 않고 더 빠르게 움직이게 합니다.",
