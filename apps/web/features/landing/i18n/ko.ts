...
export function createKoDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Enact는 코딩 AI 에이전트를 진짜 팀원으로 만들어 주는 오픈소스 플랫폼입니다. 태스크를 맡기고, 진행 상황을 따라가고, 반복되는 노하우를 스킬로 쌓아 두세요. 사람과 AI 에이전트로 이루어진 팀을 한곳에서 관리할 수 있습니다.",
      cta: "무료로 시작하기",
      downloadDesktop: "데스크톱 다운로드",
      talkToSales: "영업팀에 문의",
      worksWith: "지원 도구",
      imageAlt: "사람과 AI 에이전트가 함께 태스크를 관리하는 Enact 보드 화면",
    },
    features: {
      teammates: {
        label: "팀원",
      ...
      autonomous: {
        ...
        description:
          "한 번 답하고 끝나는 프롬프트 도구가 아닙니다. 작업을 대기열에 넣고, 가져오고, 실행하고, 완료 또는 실패까지 보고하는 흐름 전체를 Enact가 관리합니다. 막힌 부분은 에이전트가 먼저 알려 주고, 진행 상황은 실시간으로 올라옵니다.",
        cards: [
          {
            title: "처음부터 끝까지 추적",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "Enact는 Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI 등 23개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "`enact setup`을 실행하면 로그인, 데몬 실행, 지원 코딩 도구 스캔까지 차례대로 안내합니다. 이미 설치된 도구는 자동으로 런타임에 등록됩니다.",
        },
        {
          title: "첫 에이전트 만들기",
          description:
    ...
    openSource: {
      ...
      headlineLine2: "오픈소스.",
      description:
        "Enact는 완전한 오픈소스입니다. 코드를 직접 들여다보고, 원하는 환경에 셀프 호스팅하고, 사람과 AI 에이전트가 함께 일하는 방식을 같이 만들어 갈 수 있습니다.",
      cta: "GitHub에서 스타 누르기",
      highlights: [
        {
          title: "어디서든 셀프 호스팅",
          description:
            "자체 인프라에서 Enact를 직접 운영하세요. Docker Compose, 단일 바이너리, Kubernetes를 지원하며, 데이터는 여러분의 네트워크 안에 그대로 남습니다.",
        },
        {
          title: "벤더 종속 없음",
          description:
    ...
    faq: {
      ...
      items: [
        {
          question: "Enact는 어떤 코딩 에이전트를 지원하나요?",
          answer:
            "Enact는 Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, Trae CLI 등 23개 코딩 도구를 기본 지원합니다. 데몬이 이미 설치된 CLI를 자동으로 찾아 각각 런타임으로 등록합니다. 오픈소스이므로 직접 백엔드를 추가할 수도 있습니다.",
        },
        {
          question: "셀프 호스팅만 가능한가요, 클라우드 버전도 있나요?",
          answer:
            "둘 다 가능합니다. Docker Compose나 Kubernetes로 자체 인프라에 직접 호스팅할 수도 있고, Enact가 운영하는 클라우드 버전을 그대로 쓸 수도 있습니다. 데이터를 어디에 둘지는 직접 선택할 수 있습니다.",
        },
        {
          question: "코딩 에이전트를 직접 쓰는 것과 무엇이 다른가요?",
          answer:
            "코딩 에이전트는 실행에 강합니다. Enact는 그 위에 작업 대기열, 팀 협업, 스킬 재사용, 런타임 모니터링, 에이전트별 작업 현황을 한눈에 보는 통합 화면을 얹습니다. 에이전트를 팀 안에서 운영하기 위한 관리 계층이라고 보시면 됩니다.",
        },
        {
          question: "에이전트가 긴 작업도 자율적으로 처리할 수 있나요?",
          answer:
            "네. Enact는 대기열 등록, 수락, 실행, 완료 또는 실패까지 작업 흐름 전체를 관리합니다. 에이전트는 막힌 부분을 먼저 알려 주고, 진행 상황은 실시간으로 기록됩니다.",
        },
        {
          question: "코드는 안전한가요? 에이전트는 어디서 실행되나요?",
          answer:
            "에이전트 실행은 사용자의 컴퓨터에 있는 로컬 데몬, 또는 직접 운영하는 클라우드 인프라에서 이뤄집니다. 코드는 Enact 서버를 거치지 않습니다. Enact는 작업 상태를 조율하고 이벤트를 전달하는 역할만 합니다.",
        },
        {
    ...
    changelog: {
      title: "변경 로그",
      subtitle: "Enact의 새로운 업데이트와 개선 사항입니다.",
      toc: "모든 릴리스",
      categories: {
        features: "새 기능",
        improvements: "개선 사항",
      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "휴대폰 홈 화면에 Enact를 추가해 앱처럼 열 수 있어요.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "남은 태스크 파일 때문에 그 폴더의 enact 명령이 멈추지 않습니다.",
        ...
        },
        {
          ...
          improvements: [
            "`enact daemon logs`가 로그 파일 위치를 바로 알려줍니다.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "남아 있던 포트 설정 때문에 `enact login`이 막히지 않습니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Enact의 어떤 링크든 Cmd/Ctrl 또는 가운데 클릭으로 새 탭에서 열 수 있어요.",
        ...
        },
        {
          ...
          features: [
            ...
            "enact나 Agent CLI를 바꿔 두면 다시 시작하지 않아도 그대로 반영됩니다.",
          ],
          improvements: [
        ...
        },
        {
          ...
          improvements: [
            ...
            "워크스페이스가 많아도 Enact를 시작할 때 에이전트 도구를 반복 확인하지 않습니다.",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 데스크톱 앱이 enact-desktop이라는 이름으로 설치됩니다.",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          features: [
            ...
            "ENAC-123 같은 태스크 번호를 입력하거나 붙여넣으면 자동으로 클릭할 수 있는 태스크 링크가 됩니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "셀프호스트(Helm): 새 `postgres.external.enabled` 토글로 Enact를 외부 관리형 PostgreSQL(RDS, CNPG, Cloud SQL, Neon 등)에 연결하고 내장 DB를 건너뛸 수 있습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack의 네이티브 /issue 슬래시 명령이 Enact 태스크를 생성하고 실행자에게만 태스크 링크를 개인 메시지로 회신합니다.",
            "같은 Slack 워크스페이스에서 이미 한 Enact 봇과 계정을 연결한 사용자는, 새로 추가된 다른 봇에서 다시 연결을 요구받지 않습니다.",
          ...
          fixes: [
            ...
            "셀프호스트: docker-compose.selfhost.yml에서 ENACT_SLACK_SECRET_KEY가 백엔드 컨테이너로 전달됩니다. (커뮤니티 보고)",
            "태스크 보드 상단의 «N개 처리 중» 칩이 에이전트가 아니라 태스크 수를 기준으로 집계됩니다.",
            "셀프호스트 익명 소스 채널 리포팅 대상이 정식 Enact API로 복원되었습니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack 채널의 과거 대화를 Enact로 백필할 수 있어, 에이전트가 채널에 합류한 순간부터 이전 맥락을 알 수 있습니다.",
            "Slack에서 에이전트가 응답을 준비하는 동안 사용자 메시지에 👀 반응이 표시되고, 종료 시 안정적으로 제거됩니다.",
            "스킬 번들을 로컬 .skill / .zip 아카이브에서 가져올 수 있습니다.",
            "enact issue 계열 명령은 더 이상 짧은 UUID 접두사를 받지 않습니다. 태스크 Key(ENAC-123) 또는 전체 UUID를 사용하세요.",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor와 OpenClaw 설정이 더 쉬워졌습니다. Cursor 연결 설정은 Enact가 관리할 수 있고, OpenClaw는 기존 게이트웨이에 연결할 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy로 로컬 Enact 에이전트를 실행할 수 있으며, 사용할 수 있는 모델과 실행 강도 선택지가 자동으로 표시됩니다.",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5가 Enact의 지원 모델과 가격 목록에 추가되었습니다.",
            "태스크 대화에서 특정 답글을 해결 답변으로 남길 수 있어, 긴 스레드를 접어도 결론을 더 쉽게 확인할 수 있습니다.",
            "Lark와 Feishu 대화는 Enact가 답변을 준비하는 동안 입력 중 반응을 표시하고, 답변을 보내기 전에 자동으로 지웁니다.",
          ...
          improvements: [
            ...
            "WSL2처럼 Enact 밖에서 데몬을 관리하는 경우 데스크톱은 시작과 중지 조작을 비활성화합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "웹 앱에서 브라우저 기본 알림 배너를 표시할 수 있어 Enact가 백그라운드에 있어도 워크스페이스 활동을 더 쉽게 확인할 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Enact가 Lark 서드파티 연동을 지원해 QR 코드를 스캔하면 Enact 에이전트를 Lark Bot으로 만들 수 있습니다.",
            ...
            "에이전트에 Enact 기본 스킬이 포함되어 워크스페이스의 작업 흐름을 더 일관되게 따를 수 있습니다.",
          ],
          improvements: [
        ...
        },
        {
          ...
          features: [
            ...
            "Enact가 앱, 웹사이트, 문서에서 한국어를 지원하며, 전체 한국어 문서와 한국어 날짜 표시를 제공합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "처음으로 실제 사용 가능한 모바일 클라이언트인 Enact for iOS가 출시되어, 로그인·워크스페이스·인박스·태스크·프로젝트·채팅·댓글·실시간 업데이트를 모두 지원합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub를 연결해 연결된 Pull request를 Enact 태스크에 표시하고 상태를 동기화하며 PR 종료 시 태스크를 자동으로 닫을 수 있습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact daemon disk-usage`가 작업별, 워크스페이스별 디스크 사용량을 보여줍니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact repo checkout --ref`가 브랜치, 태그, 특정 커밋을 대상으로 저장소를 가져올 수 있습니다.",
            "`enact agent avatar`가 CLI에서 에이전트 아바타를 직접 업로드합니다.",
          ...
          fixes: [
            "새 에이전트 즉시 표시, Hermes 이전 답변 재생, Codex GPT-5.5 모델 표시, `enact login --token`, CLI 업데이트 상태, session resume, Kanban 설정, 오토파일럿 반응형 등을 수정했습니다.",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "데몬 claim polling의 Redis fast-path와 Enact Agent 커밋의 Co-authored-by trailer, 데스크톱 reload 차단이 개선되었습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact agent create/update --custom-env KEY=VALUE`가 에이전트 실행에 사용자 지정 환경 변수를 주입합니다.",
    ...
    about: {
      ...
      paragraphs: [
        "Enact라는 이름은 1960년대의 선구적인 운영체제 Multics에서 따왔습니다. Multics는 여러 사용자가 하나의 컴퓨터를 공유하면서도 각자 자기 컴퓨터를 쓰는 것처럼 느끼게 해 주는 시분할이라는 개념을 처음 널리 퍼뜨렸습니다. Unix는 Multics를 의도적으로 단순화하며 태어났습니다. 한 사용자, 한 작업, 하나의 우아한 철학에 집중한 결과였습니다.",
        "지금 비슷한 전환점이 다시 오고 있다고 봅니다. 지난 수십 년 동안 소프트웨어 팀은 사실상 단일 스레드로 일해 왔습니다. 엔지니어 한 명이 한 작업을 맡고, 한 번에 하나의 맥락만 다루는 식이었습니다. AI 에이전트는 이 공식을 바꿉니다. Enact는 시분할의 발상을 다시 꺼내 오되, 이번에는 시스템을 함께 쓰는 \"사용자\"가 사람과 자율 에이전트 양쪽을 의미하는 시대에 맞게 다시 풀어냅니다.",
        "Enact에서 에이전트는 정식 팀원입니다. 사람 동료와 똑같이 태스크를 할당받고, 진행 상황을 보고하고, 막힌 부분을 알리고, 코드를 배포합니다. 담당자 선택, 활동 타임라인, 작업 생명주기, 런타임 인프라는 모두 이 전제를 중심으로 처음부터 설계되었습니다.",
        "Multics가 그랬듯, 핵심은 multiplexing입니다. 작은 팀이라고 작게 움직일 필요는 없습니다. 올바른 시스템이 있다면 엔지니어 두 명과 에이전트 한 무리가 스무 명짜리 팀처럼 움직일 수 있습니다.",
        "Enact는 완전한 오픈소스이며 셀프 호스팅할 수 있습니다. 데이터는 여러분의 인프라 안에 그대로 남습니다. 모든 코드를 들여다보고, API를 확장하고, 원하는 LLM 제공자를 연결하고, 커뮤니티에 기여할 수 있습니다.",
      ],
      cta: "GitHub에서 보기",
    },
    download: {
      ...
      cloud: {
        ...
        sub: "Enact가 런타임을 직접 호스팅해 드립니다. 아직 정식 출시 전입니다. 이메일을 남겨 주시면 준비되는 대로 알려드릴게요.",
      },
      footer: {
    ...
    contactSales: {
      pageTitle: "영업팀 문의",
      pageDescription:
        "회사에 사람과 에이전트가 함께 일하는 워크플로를 도입하는 방법을 Enact 팀과 함께 이야기해 보세요.",
      eyebrow: "영업팀 문의",
      ...
      fields: {
        ...
        companySize: "회사 규모",
        countryRegion: "국가 / 지역",
        useCase: "Enact를 어떻게 사용하거나 어디에 활용하실 계획인가요?",
        goals: "목표 또는 현재 겪고 있는 과제",
        goalsHint:
          "Enact로 이루고 싶은 일이나 지금 겪고 있는 문제를 알려 주세요. 자세히 적어 주실수록 더 알맞게 도와드릴 수 있습니다.",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "팀 또는 회사에 Enact 도입" },
        { value: "self_host", label: "자체 인프라에 셀프 호스팅" },
        { value: "integrate", label: "기존 도구와 Enact 연동" },
      ...
      consent: {
        intro:
          "Enact, Inc.는 여러분의 개인정보를 소중히 다룹니다. 제공해 주신 개인정보는 계정 관리와 요청하신 제품·서비스 제공에만 사용합니다. 가끔씩 제품 업데이트, 활용 팁, 도움이 될 만한 인사이트도 함께 전해 드리고 싶습니다. 소식을 받고 싶으시다면 아래에서 선택해 주세요.",
        outreach:
          "서비스 업데이트, 지원 문의, 비즈니스 관련 후속 연락 등 Enact, Inc.로부터 개별 연락을 받겠습니다.",
        updates:
          "Enact의 제품 업데이트, 인사이트, 이벤트 초대 소식을 받겠습니다.",
        unsubscribe:
          "언제든 수신을 거부할 수 있습니다. 개인정보와 데이터 권리를 어떻게 다루는지는 다음 문서에서 자세히 확인하실 수 있습니다:",
        submitConsent:
          "\"제출\"을 클릭하시면 요청하신 콘텐츠를 보내 드리기 위해 Enact, Inc.가 정보를 저장하고 처리하는 것에 동의하게 됩니다.",
      ...
      success: {
        ...
        message:
          "Enact 팀원이 영업일 기준 3일 이내에 답변드릴 예정입니다. 그동안 문서를 둘러보시거나 GitHub에서 스타를 눌러 주세요.",
        cta: "홈으로 돌아가기",
      },
      errors: {
