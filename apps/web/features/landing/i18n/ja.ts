...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Enact は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "営業に相談する",
      worksWith: "対応ツール",
      imageAlt: "人間と AI エージェントがタスクを管理する Enact のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。作業をキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を Enact が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Enact は Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI という23種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
      ...
      steps: [
        {
          ...
          description: allowSignup
            ? "メールアドレスを入力すれば完了です。ワークスペースは自動的に作成され、セットアップウィザードも設定フォームもありません。"
            : "メールアドレスを入力すれば、そのままワークスペースにログインできます。セットアップウィザードも設定フォームもありません。",
        },
        {
          title: "CLI をインストールしてマシンを接続",
          description:
            "enact setup を実行すると、OAuth の手順を案内し、デーモンを起動し、23種類の対応コーディングツール(Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
    ...
    openSource: {
      ...
      description:
        "Enact は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Enact を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Enact はその上に、タスクキュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間のタスクを自律的にこなせますか?",
          answer:
            "はい。Enact は、キュー追加・受け取り・実行・完了または失敗まで、タスクのライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Enact のサーバーを経由することはありません。プラットフォームはタスクの状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Enact の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "Enact をスマホのホーム画面に追加して、アプリのように開けます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクの残りファイルで、そのフォルダーの enact コマンドが止まりません。",
        ...
        },
        {
          ...
          improvements: [
            "`enact daemon logs` がログファイルの場所を教えてくれます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Enact のどのリンクでも、Cmd/Ctrl または中クリックで新しいタブに開けます。",
            "WeCom につながらないとき、拒否されたのか届かないのかをページが示します。",
          ],
          improvements: [
            "サインアップの直後に、Enact の最初のメッセージがすぐ表示されます。",
            "保存したビューは昇順と降順を選べます。",
        ...
        },
        {
          ...
          improvements: [
            ...
            "多くのワークスペースがあっても、Enact の起動時にエージェントツールを何度も確認しなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が Enact 内に残るようになりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 版デスクトップ アプリが enact-desktop という名前でインストールされます。",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          features: [
            ...
            "ENAC-123 のようなタスク番号を入力または貼り付けると、自動でクリックできるタスクリンクになります。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクの PR 一覧には、そのタスクを実際に対象にしている PR だけが表示され、本文で「Related to ENA-…」と触れているだけの PR は非表示になりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Enact を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで Enact タスクを作成し、実行者だけにタスクリンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Enact ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          fixes: [
            ...
            "セルフホスト：docker-compose.selfhost.yml で ENACT_SLACK_SECRET_KEY をバックエンド コンテナへ引き渡すようになりました。（コミュニティ報告）",
            "タスク一覧上部の「N 件処理中」チップが、エージェントではなくタスクの数を数えるようになりました。",
            "セルフホストの匿名ソース チャネル送信先を正式な Enact API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを Enact にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
            "Slack でエージェントが返信を準備している間、ユーザーのメッセージに 👀 のリアクションが付き、終了時に確実に外れます。",
            "スキル パッケージをローカルの .skill / .zip アーカイブから取り込めるようになりました。",
            "enact issue 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。タスク Key（ENAC-123）または完全な UUID を指定してください。",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Enact に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Enact エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5 が Enact の対応モデルと料金一覧に加わりました。",
            "タスクの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Enact が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Enact の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Enact がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Enact は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Enact エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックリストを使えるようになり、タスク内の軽い計画を整理しやすくなりました。",
            "エージェントに Enact の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Enact がアプリ、サイト、ドキュメントで日本語に対応しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Enact がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Enact for iOS をリリースし、ログイン・ワークスペース・インボックス・タスク・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "新規ユーザーは Enact との対話で実際の最初のタスクを完了し、必要な場合だけ specialist を追加するオンボーディングを利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Enact のタスクに表示し、状態を同期し、PR がクローズされたときにタスクを自動的に閉じられます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact daemon disk-usage` が、作業ごと・ワークスペースごとのディスク使用量を表示します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact repo checkout --ref` が、ブランチ、タグ、特定のコミットを対象にリポジトリを取得できます。",
            "`enact agent avatar` が、CLI からエージェントのアバターを直接アップロードします。",
          ...
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`enact login --token`、CLI 更新の状態、session resume、Kanban 設定、オートパイロットのレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "デーモンの claim polling の Redis fast-path、Enact Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`enact agent create/update --custom-env KEY=VALUE` が、エージェントの実行にカスタム環境変数を注入します。",
    ...
    about: {
      title: "Enact について",
      nameLine: "Enact は意図を、追跡可能で責任ある行動に変えます。",
      paragraphs: [
        "Enact では、エージェントは一級のチームメンバーです。人間の同僚とまったく同じように、タスクを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードをリリースします。担当者の選択、アクティビティタイムライン、作業のライフサイクル、そしてランタイムのインフラは、すべてこの前提を中心に、最初から設計されています。",
        "Enact は、人の判断、エージェントの実行、プロジェクトの文脈をひとつの共有システムにまとめ、小さなチームが統制を失わずに速く進めるようにします。",
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Enact チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Enact をどのように利用、または活用するご予定ですか?",
        goals: "目標または現在抱えている課題",
        goalsHint:
          "Enact で実現したいことや、いま直面している課題をお聞かせください。詳しくご記入いただくほど、より的確にお手伝いできます。",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Enact を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Enact を連携" },
      ...
      consent: {
        intro:
          "Enact, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Enact, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Enact からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Enact, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Enact チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
