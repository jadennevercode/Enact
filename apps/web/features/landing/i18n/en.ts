...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    subheading:
      "Enact is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "Enact board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Enact scans for 23 supported coding tools \u2014 Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, and Trae CLI \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  openSource: {
    ...
    description:
      "Enact is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Enact on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Enact support?",
        answer:
          "Enact supports 23 coding tools out of the box: Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, DeepSeek Harness, DevEco Code, Dim, Grok, Hermes, Kimi, Kiro CLI, Oh-My-Pi, OpenClaw, OpenCode, Pi, Qoder, Qoder CN, Qwen Code, QwenPaw, Reasonix, and Trae CLI. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
        question: "Do I need to self-host, or is there a cloud version?",
        answer:
          "Both. You can self-host Enact on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Enact adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Enact manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Enact servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  footer: {
    ...
    groups: {
      ...
      resources: {
        ...
        links: [
          ...
          { label: "X (Twitter)", href: "https://x.com/EnactAI" },
    ...
    copyright: "\u00a9 {year} Enact. All rights reserved.",
  },
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Enact.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        features: [
          ...
          "You can now add Enact to your phone's home screen and open it like an app.",
      ...
      },
      {
        ...
        fixes: [
          ...
          "Leftover task files no longer break every enact command in a folder.",
      ...
      },
      {
        ...
        improvements: [
          "`enact daemon logs` now tells you where the log file is.",
      ...
      },
      {
        ...
        fixes: [
          ...
          "A leftover port setting no longer blocks `enact login`.",
      ...
      },
      {
        ...
        features: [
          ...
          "Cmd/Ctrl+click or middle-click any link in Enact to open it in a new tab.",
      ...
      },
      {
        ...
        features: [
          ...
          "Replacing your enact or agent CLI now takes effect on its own, no restart.",
        ],
        improvements: [
      ...
      },
      {
        ...
        improvements: [
          ...
          "Dimmed text across Enact is now solid and readable instead of washed out.",
        ],
        fixes: [
      ...
      },
      {
        ...
        improvements: [
          ...
          "Enact's interface and four-language docs are more consistent and readable.",
        ...
        fixes: [
          ...
          "Qoder CLI is now found when Enact starts from a desktop app.",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Starting Enact with many workspaces now launches far fewer agent checks.",
      ...
      },
      {
        ...
        fixes: [
          ...
          "Direct chat replies now stay in Enact.",
      ...
      },
      {
        ...
        fixes: [
          ...
          "The Linux desktop app now installs under the name enact-desktop.",
        ],
      },
      {
        version: "0.4.2",
      ...
      },
      {
        ...
        features: [
          ...
          "Self-hosted (Helm): a new `postgres.external.enabled` toggle points Enact at an externally managed PostgreSQL (RDS, CNPG, Cloud SQL, Neon…) and skips the built-in database.",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Slack's native /issue slash command creates a Enact Issue and replies to you privately with the link.",
          "A Slack user who already linked their account to one Enact bot no longer re-links when the same Slack workspace connects a second bot.",
        ...
        fixes: [
          ...
          "Self-host: ENACT_SLACK_SECRET_KEY is now passed through to the backend container in docker-compose.selfhost.yml. (Community-reported.)",
          "The Issues board \"N working\" chip counts distinct Issues instead of distinct agents.",
          "Anonymous self-host source-channel reports go back to the official Enact API endpoint.",
      ...
      },
      {
        ...
        improvements: [
          "The local daemon reconnects to Enact through a more resilient WebSocket flow with bounded backoff, so brief network drops recover smoothly instead of stalling.",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "CodeBuddy can now run local Enact agents, with its available model and effort choices shown automatically",
      ...
      },
      {
        ...
        features: [
          ...
          "Claude Fable 5 is now available in Enact's supported model and pricing list",
          ...
          "Lark and Feishu conversations now show a typing reaction while Enact is preparing a reply, then clear it before the answer is sent",
          "Agent runs now know who started each task, making handoffs, audit trails, and privacy-aware behavior more accurate",
          "OpenClaw users can point Enact at a custom app location and data folder from their local configuration",
        ],
        improvements: [
          "Comment trigger indicators are quieter, clearer, and less likely to crowd long agent names",
          "Desktop now disables daemon start and stop controls when the daemon is managed outside Enact, such as in WSL2",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "The web app can now show native browser notification banners, making workspace activity easier to catch while Enact is in the background",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Enact now supports Lark as a third-party integration, so teams can scan a QR code and create a Enact agent as a Lark Bot",
          ...
          "Agents now include built-in Enact skills so they can follow workspace workflows more consistently",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Enact now supports Japanese across the app, site, and docs",
      ...
      },
      {
        ...
        features: [
          ...
          "Enact now supports Korean across the app, public site, and documentation, including Korean docs pages and localized date formatting",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Enact shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Enact for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Enact for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Enact to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Enact tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Enact",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Enact issues, sync their status, and close the Enact issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Enact app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Enact asterisk",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`enact repo checkout --ref` targets a branch, tag, or specific commit when pulling a repo into the workspace",
          "`enact agent avatar` uploads an agent avatar straight from the CLI",
        ...
        fixes: [
          ...
          "`enact login --token <PAT>` accepts the PAT as a flag value instead of rejecting it",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Enact Agent commits include a `Co-authored-by` trailer for proper Git attribution",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Backend default agent CLI args via `ENACT_CLAUDE_ARGS` / `ENACT_CODEX_ARGS` env vars",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`enact agent create/update --custom-env KEY=VALUE` injects custom environment variables into agent runs",
          "Agent failure messages now include a tail of the runtime CLI's stderr — much easier to debug runtime errors",
          "CLI update download timeout is now configurable, so slow links no longer abort `enact update`",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "`enact update` self-update command — upgrade the CLI and local daemon without reinstalling",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Per-agent `model` field with a provider-aware dropdown — pick the LLM model for each agent from the UI or via `enact agent create/update --model`, with live discovery from each runtime's CLI",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "One-click install & setup — `curl | bash` installs CLI, `--with-server` bootstraps full self-hosting, `enact setup` configures your environment",
      ...
      },
      {
        ...
        changes: [
          ...
          "Daemon ensures enact CLI is on PATH in agent task environment",
  ...
  contactSales: {
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Enact?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Enact or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Enact for my team" },
      { value: "adopt_team", label: "Rolling out Enact to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Enact with existing tools" },
    ...
    consent: {
      intro:
        "Enact, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Enact, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Enact.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Enact, Inc. to store and process your information for the purpose of delivering the requested content.",
    ...
    success: {
      ...
      message:
        "A member of the Enact team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
