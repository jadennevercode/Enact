...
import { StatusIcon, PriorityIcon } from "@enact/views/issues/components";
import { STATUS_CONFIG } from "@enact/core/issues/config/status";
import { PRIORITY_CONFIG } from "@enact/core/issues/config/priority";
import type { IssueStatusCategory, IssuePriority } from "@enact/core/types";
...
const mockToolCalls = [
  ...
  { type: "tool_result" as const, preview: "ok  \tgithub.com/enact/server/internal/handler\t0.847s" },
];
