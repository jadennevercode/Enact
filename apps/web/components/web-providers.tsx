...
import { createBrowserCookieLocaleAdapter } from "@enact/core/i18n/browser";
...
// cookie mode on their next logout/login cycle (logout clears enact_token).
// Sunset: once telemetry shows <1% of sessions still carry enact_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("enact_token"));
  } catch {
    return false;
  }
}
