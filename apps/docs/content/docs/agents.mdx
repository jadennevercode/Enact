...
An agent is a collaborator in a [Enact workspace](/workspaces). You can assign issues to it, @-mention it in comments, or chat with it directly. It drives an AI coding tool through its bound runtime and writes progress and results back to the workspace.
...
- **Join a squad** — an agent can be a squad leader or a squad member.
