---
title: ログインとサインアップ
description: メール直接ログイン、Google ログイン、新規登録の範囲を設定します。
---

import { Callout } from "fumadocs-ui/components/callout";

Enact はデフォルトでメールアドレスによる直接ログインを使い、Google OAuth を追加することもできます。既存のユーザーはいつでも再ログインできます。サインアップ制限は、新しいアカウントを作成できるかどうかだけを決めます。

## メール直接ログイン

ユーザーがメールアドレスを入力して続行すると、Enact は対応するアカウントを作成または再利用し、すぐにログイン cookie を発行します。認証コードの手順はありません。
