---
title: 参与开发
description: 配置 Enact 本地开发环境，运行测试，并按仓库约定提交改动。
---

import { Callout } from "fumadocs-ui/components/callout";

Enact 是 Go backend 与 pnpm monorepo。最简单的本地启动方式是 `make dev`；它会为当前 checkout 准备环境、数据库和 migration，再启动 Web 与 API。
