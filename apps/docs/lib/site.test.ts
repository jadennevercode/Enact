...
describe("docsAlternates", () => {
  it("omits Korean hreflang when no Korean MDX file exists for the page", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      canonical: "https://www.enact.ai/docs/agents",
      languages: {
        en: "https://www.enact.ai/docs/agents",
        zh: "https://www.enact.ai/docs/zh/agents",
        "x-default": "https://www.enact.ai/docs/agents",
      },
    });
  });
  ...
  it("includes Korean hreflang when a real *.ko.mdx page exists", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      ...
      languages: {
        en: "https://www.enact.ai/docs/agents",
        zh: "https://www.enact.ai/docs/zh/agents",
        ko: "https://www.enact.ai/docs/ko/agents",
        "x-default": "https://www.enact.ai/docs/agents",
      },
    });
  });
  ...
  it("includes Japanese hreflang when a real *.ja.mdx page exists", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      ...
      languages: {
        en: "https://www.enact.ai/docs/agents",
        zh: "https://www.enact.ai/docs/zh/agents",
        ja: "https://www.enact.ai/docs/ja/agents",
        "x-default": "https://www.enact.ai/docs/agents",
      },
    });
  });
  ...
  it("keeps the locale root alternates limited to real localized MDX pages", async () => {
    ...
    expect(docsAlternates([])).toEqual({
      canonical: "https://www.enact.ai/docs",
      languages: {
        en: "https://www.enact.ai/docs",
        zh: "https://www.enact.ai/docs/zh",
        "x-default": "https://www.enact.ai/docs",
      },
    });
  });
});
