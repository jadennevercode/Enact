 ...
 *
 * URI resolution: markdown content authored in Enact stores image
...
import { matchAttachmentByURL } from "@enact/core/attachments/image-sequence";
...
export function MarkdownImage({ uri, attachments }: Props) {
  ...
  const resolvedUri = useMemo(() => {
    ...
    // configured — see ENA-2976. RN's image loader has no document
