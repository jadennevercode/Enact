 ...
 * yet schematised in @enact/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@enact/core/api/schemas";
...
// availability derivation in @enact/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@enact/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
