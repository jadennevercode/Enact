 ...
 *
 * Types are imported via `import type` from @enact/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @enact/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Enact payload size on cellular. */
