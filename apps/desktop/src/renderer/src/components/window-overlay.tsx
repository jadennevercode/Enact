...
import { InvitePage } from "@enact/views/invite";
import { InvitationsPage } from "@enact/views/invitations";
import { OnboardingFlow } from "@enact/views/onboarding";
import { useNavigation } from "@enact/views/navigation";
        ...
        <OnboardingFlow
          ...
          onComplete={(ws, destination) => {
            ...
            if (ws && destination?.kind === "chat") {
              ...
              push(paths.workspace(ws.slug).home());
            }
          }}
        />
      )}
