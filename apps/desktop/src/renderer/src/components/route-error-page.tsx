 ...
 * "recovery" button pointing at `/Users/issues`, i.e. a second 404 (ENA-4899).
...
export function DesktopRouteErrorPage() {
  ...
  // ENA-4899: 8 of 18 desktop_route_error reports were users clicking an agent's
      ...
      <div className="flex gap-2">
        {recoveryRoute ? (
          <Button
            ...
            // the new session URL into the router (ENA-4741 invariant 1).
            onClick={() =>
              useTabStore
                .getState()
