        ...
        <SettingsRow
          ...
          description={
            cliInstalled === null
              ? "Checking…"
              : cliInstalled
                ? "enact CLI is installed and available in PATH."
                : "enact CLI not found. Install it to enable daemon management."
          }
        >
          {cliInstalled === false && (
            <Button
              ...
              onClick={() =>
                window.desktopAPI.openExternal(
                  "https://github.com/enact-ai/enact#cli-installation",
                )
              }
            >
              Installation Guide
