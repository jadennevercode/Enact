...
} from "@enact/core/workspace";
import { getCurrentSlug, setCurrentWorkspace } from "@enact/core/platform";
import { isWorkspaceDeletePending } from "@enact/core/workspace/pending-delete";
 ...
 * a successor has already taken over (ENA-6303 / #7086).
 *
...
export function WorkspaceRouteLayout() {
  ...
  // code and violated ENA-4741 invariant 1 (only the Coordinator navigates).
  ...
  // the delete flow's own cleanup (ENA-6231 / #7021). useDeleteWorkspace
  ...
  // chrome over a workspace that no longer existed (ENA-6231 / #7021).
  //
  ...
  // the workspace context (ENA-6303 / #7086). The slug check alone cannot see
