export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--enact-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.enact.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.enact.invalid") return null;
