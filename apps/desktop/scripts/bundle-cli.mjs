#!/usr/bin/env node
// Builds the `enact` CLI from server/cmd/enact and copies the binary
...
//
// ldflags mirror `make build` so `enact --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "enact.exe" : "enact";
}
