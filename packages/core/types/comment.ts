...
// child-done notification, ENA-2538). System rows carry a zero UUID for
...
export interface Comment {
  ...
  // The quick action that produced this comment (ENA-5465). A quick action
  ...
  // (ENA-4525 §2). Present only on create/edit responses; older servers omit it.
...
export interface CommentTriggerPreview {
  ...
  // (ENA-4525 §2). Additive: older servers omit it.
