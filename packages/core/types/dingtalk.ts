/** A DingTalk robot installation bound to a single Enact agent.
 *
...
export interface DingTalkInstallation {
  ...
  /** DingTalk staff ids linked by the currently authenticated Enact user for
...
/** One connected Enact bot observed in a DingTalk group. */
 ...
 * the logged-in Enact user in this workspace/installation. */
