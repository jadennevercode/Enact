...
export interface Agent {
   ...
   *  template-created agents. Identity for "maintained by Enact" checks —
 ...
 * enact-ai/enact#2174). Use `Skill` from a detail endpoint when you need
...
export interface RuntimeModelThinking {
   ...
   *  but not actively rendered today — Enact's empty `thinking_level`
