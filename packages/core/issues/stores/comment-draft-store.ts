 ...
 * composer session (ENA-5181). Uploads used to live in component `useState`,
...
interface CommentDraftStore {
   ...
   * ENA-5181): an upload that finished after its composer unmounted has no
...
registerDraftCleanup({
  storageKey: "enact_comment_drafts",
