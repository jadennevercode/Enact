...
const AGENT_STORAGE_KEY = "enact:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "enact:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "enact:chat:activeSessionId";
...
const DRAFT_ATTACHMENTS_KEY = "enact:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "enact:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "enact:chat:pending-send-restores";
/**
...
const CHAT_EXPANDED_KEY = "enact:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "enact:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "enact:chat:floatingChatEnabled";
