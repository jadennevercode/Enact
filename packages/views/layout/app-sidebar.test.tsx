...
vi.mock("@enact/ui/components/ui/collapsible", () => ({
...
vi.mock("@enact/core/issues/queries", () => ({ issueDetailOptions: () => ({ queryKey: ["issue"] }) }));
...
vi.mock("@enact/core/issues/stores/draft-store", () => ({ useIssueDraftStore: () => false }));
