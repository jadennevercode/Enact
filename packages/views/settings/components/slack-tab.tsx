...
import { slackInstallationsOptions, slackKeys } from "@enact/core/slack";
import { api } from "@enact/core/api";
import type { SlackInstallation } from "@enact/core/types";
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://enact.ai/docs${prefix}/slack-bot-integration`;
}
