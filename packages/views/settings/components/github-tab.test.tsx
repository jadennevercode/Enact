...
vi.mock("@enact/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@enact/core/github")>("@enact/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Enact will stop receiving webhooks/i)).toBeTruthy();
