...
// ApiError is re-exported from @enact/core/api; we mock the api module
...
// row uses it to render the Enact agent's name in place of the raw
...
// renders the Enact agent's avatar + name (joined via inst.agent_id),
...
describe("LarkTab connected bots list (agent identity rendering)", () => {
  ...
  it("renders the Enact agent's name and avatar instead of the raw Lark app_id / bot_open_id", () => {
