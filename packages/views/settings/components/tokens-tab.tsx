...
import type { PersonalAccessToken } from "@enact/core/types";
import { Alert, AlertDescription } from "@enact/ui/components/ui/alert";
...
export function TokensTab() {
  ...
  const handleCopyCommand = async () => {
    if (!newToken) return;
    if (await copyText(`enact login --token ${newToken}`)) {
