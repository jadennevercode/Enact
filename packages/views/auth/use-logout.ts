...
import { clearWorkspaceStorage, defaultStorage } from "@enact/core/platform";
import { resetAllRegisteredDrafts } from "@enact/core/drafts/cleanup-registry";
...
export function useLogout() {
  ...
  return useCallback(() => {
    ...
    defaultStorage.removeItem("enact_tabs");
