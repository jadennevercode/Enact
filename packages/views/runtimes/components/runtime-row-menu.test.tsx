...
import type { AgentRuntime, RuntimeProfile } from "@enact/core/types";
...
vi.mock("@enact/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared enact daemon `cli_version`. It must instead show the agent's own
