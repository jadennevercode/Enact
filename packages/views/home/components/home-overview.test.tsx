...
describe("HomeOverview: needs you", () => {
  const blocked = {
    id: "n1",
    type: "agent_blocked",
...
describe("HomeOverview: automation trouble", () => {
  const base = {
    id: "a1",
...
describe("HomeOverview: empty workspace", () => {
  // A workspace with no usable agent cannot fill any of the blocks, so it
  // gets one instruction instead of five empty states.
