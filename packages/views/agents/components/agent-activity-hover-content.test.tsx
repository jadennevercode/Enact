...
// "3 agents working" for those two agents, contradicting the chip. ENA-3872.
...
describe("WorkspaceAgentActivityHoverContent", () => {
  it("carries the two figures the chip does not, and groups rows by issue", () => {
    renderWithI18n(
      <WorkspaceAgentActivityHoverContent
        issues={[
          makeIssue("i-1", "ENA-4879", "Counting logic looks wrong"),
          makeIssue("i-2", "ENA-4881", "daemon extra work dir"),
          makeIssue("i-3", "ENA-4883", "First PR review flow"),
        ]}
        tasksByIssueId={
          new Map([
            [
    ...
    expect(screen.getByText("ENA-4879")).toBeInTheDocument();
  ...
  it("says nothing about work it excludes", () => {
    ...
    renderWithI18n(
      <WorkspaceAgentActivityHoverContent
        issues={[makeIssue("i-1", "ENA-1", "One")]}
        tasksByIssueId={
