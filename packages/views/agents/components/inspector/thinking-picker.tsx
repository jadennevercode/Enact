...
import type { RuntimeModelThinkingLevel } from "@enact/core/types";
...
/**
 * Per-agent reasoning/effort picker (ENA-2339). Renders only when the
 ...
 * the user's local CLI install, not by Enact's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Enact omits
