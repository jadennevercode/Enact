...
import { useAgentPermissions } from "@enact/core/permissions";
  ...
  if (!agent && isForbidden) {
    return (
      <div className="flex flex-1 min-h-0 flex-col">
        <BackHeader paths={paths.agentsTab("agents")} title={t(($) => $.detail.back_to_agents)} />
        <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 py-16 text-center">
          ...
          <Button
            size="sm"
            render={<AppLink href={paths.agentsTab("agents")} />}
            nativeButton={false}
          >
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col">
      <DetailHeader
        ...
        runtime={runtime}
        presence={presence}
        backHref={paths.agentsTab("agents")}
            ...
            <DialogFooter>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  navigation.push(paths.agentsTab("agents"));
                }}
              >
