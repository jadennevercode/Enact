...
export function CodeBlockShell({
  ...
  return (
    <div className="code-block-wrapper enact-rich-content-code-shell group/code">
      <div className="enact-rich-content-code-toolbar">
        {language && (
          <span className="enact-rich-content-code-language">
            {language}
          </span>
        )}
        <button
