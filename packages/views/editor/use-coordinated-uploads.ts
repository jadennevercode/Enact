...
import {
  ...
  type DraftUpload,
} from "@enact/core/drafts";
import { createSafeId } from "@enact/core/utils";
import { contentReferencesAttachment, type Attachment } from "@enact/core/types";
import {
  toUploadResult,
  type UploadContext,
  type UploadResult,
} from "@enact/core/hooks/use-file-upload";
import { MAX_FILE_SIZE } from "@enact/core/constants/upload";
