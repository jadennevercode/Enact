...
import { preprocessLinks } from "@enact/ui/markdown/linkify";
...
describe("preprocessLinks — CJK punctuation boundary", () => {
  ...
  it("handles the original bug report (PR link then 。 then more text)", () => {
    const out = preprocessLinks(
      "已合并 PR #1623：https://github.com/enact-ai/enact/pull/1623。merge commit",
    );
    expect(out).toBe(
      "已合并 PR #1623：[https://github.com/enact-ai/enact/pull/1623](https://github.com/enact-ai/enact/pull/1623)。merge commit",
    );
  });
