 ...
 * identifiers (e.g. `ENA-123`) in the editable editor.
 *
 ...
 * the canonical `[ENA-123](mention://issue/<uuid>)`.
 *
...
export interface ResolvedIssueRef {
  /** Issue UUID. */
  id: string;
  /** Canonical identifier as returned by the server, e.g. "ENA-123". */
  identifier: string;
}
