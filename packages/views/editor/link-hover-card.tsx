...
function useLinkHover(containerRef: React.RefObject<HTMLElement | null>, disabled?: boolean) {
  ...
  useEffect(() => {
    ...
    const onMouseOver = (e: MouseEvent) => {
      ...
      // Mention chips render as <a class="issue-mention"> — they display
      // their own rich info, so a URL hover card is redundant, and the URL it
      // would offer to copy is an in-app path rather than the shareable link
      // the user expects.
