  ...
  useEffect(() => {
    ...
    void Promise.all([
      ...
      .then(([{ default: SigmaRenderer }, { default: Graph }, { default: forceAtlas2 }]) => {
        ...
        // Both reads come from the token system rather than a hardcoded hex;
        // --foreground covers a canvas mounted before the feature stylesheet
        // has applied, the same tolerance the semantic explorer's canvas has.
        const fallbackColor = color("--muted-foreground") || color("--foreground");
