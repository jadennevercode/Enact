...
const longRepoUrl =
  "https://github.com/enact-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/enact-ai/api";
const webRepoUrl = "https://github.com/enact-ai/web";
...
vi.mock("@enact/core/projects/mutations", () => ({
...
vi.mock("@enact/ui/components/ui/popover", () => ({
...
vi.mock("@enact/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
