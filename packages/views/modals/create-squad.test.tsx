...
import type { Agent, MemberWithUser, Squad } from "@enact/core/types";
...
vi.mock("@enact/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@enact/ui/components/ui/label", () => ({
