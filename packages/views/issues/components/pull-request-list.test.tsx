...
import type { GitHubPullRequest } from "@enact/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@enact/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@enact/core/github/queries")>(
    "@enact/core/github/queries",
  );
  return {
    ...actual,
