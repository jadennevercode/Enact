...
// Mock @enact/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@enact/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@enact/core/issues/stores/selection-store", () => ({
...
vi.mock("@enact/core/issues/stores/recent-issues-store", () => ({
