...
import { childIssueProgressOptions, issueDetailOptions } from "@enact/core/issues/queries";
...
interface IssueHoverCardProps {
   ...
   * "ENA-7"). The same label the chip degrades to, so a card that cannot load
