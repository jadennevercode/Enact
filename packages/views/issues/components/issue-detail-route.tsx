...
import { useCanonicalIssue } from "@enact/core/issues/canonical-id";
...
interface IssueDetailRouteProps {
   ...
   * human-readable identifier such as `ENA-123`.
   */
  routeId: string;
  onDelete?: () => void;
}
 ...
 * is known, so the address bar and any copied URL read as `ENA-123`.
 *
