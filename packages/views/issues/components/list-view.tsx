...
// restored scrollTop assignment stick at ref-attach (ENA-4741).
...
function ListViewImpl({
  ...
  // no-op, so groups could no longer be collapsed at all (ENA-6240).
  ...
  // Pull-based scroll restoration (ENA-4741): assign the saved offset when
...
function StatusAccordionItem({
  ...
  const listComponents = useMemo(
    () => ({
      ...
      // is ever undefined (ENA-4474). The footer itself renders null for a
  ...
  // measurement frame keeps those rows instead of flashing empty (ENA-4750).
