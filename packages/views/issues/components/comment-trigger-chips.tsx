...
import type { CommentTriggerPreviewAgent, CommentTriggerOutcome } from "@enact/core/types";
import { useAgentPresenceDetail } from "@enact/core/agents";
import { mentionLabelsByTarget } from "@enact/core/issues/comment-trigger-outcomes";
...
import { AVATAR_SIZE_PX } from "@enact/ui/lib/avatar-size";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
