    ...
    <PopoverPrimitive.Portal keepMounted={keepMounted}>
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            "enact-popup-surface z-50 flex w-72 origin-(--transform-origin) flex-col gap-2.5 p-2.5 text-body outline-hidden data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
            className
          )}
          {...props}
        />
