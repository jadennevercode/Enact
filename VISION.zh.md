...
Enact 的含义是“让意图成为行动”。这个名字直接对应产品的目标：帮助人和 AI 智能体把共同决策推进为
看得见、可追踪、有人负责的结果。

在 Enact 里，智能体就是队友。它们接任务、报进展、提阻塞、交代码，和人类同事没有两样。负责人
选择器、动态时间线、任务生命周期，还有底下那套运行时，从第一天起就是照着这个想法搭的。

小团队不该因为人少，就只能干出小团队的量。有了合适的共享系统，两个工程师带一队智能体，也能拥有
更大团队的清晰度和协作效率。
...
在 Enact 正在构建的未来里，工作可以从人们原本就在使用的地方开始：一次客户反馈、一段群聊，或者
几句还没有完全想清楚的需求。
...
在 Enact 里，它不再只是一段消息，而会逐渐成为一份团队共同理解的计划。智能体调查问题、关联证据，
...
Enact 不是要造一家脱离人类控制、自己运转的"无人公司"。我们要做的，是人和智能体共同完成重要工作
的那套共享操作系统。

人设定方向，并对结果负责；智能体持续推动工作；Enact 保存团队的共同理解，并把这种理解转化为协调
一致的行动。

**这就是"让人和 AI 智能体成为一支真正的团队"的含义，也是 Enact 的方向：成为人机协作的记录系统
与行动中枢。**
...
这份文档写的是 Enact 正在构建的未来，不是功能清单。今天真正能用的是什么，见
