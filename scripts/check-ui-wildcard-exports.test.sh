...
track "$importer"
cat >"$importer" <<'EOF'
export { UnusedExportProbe } from "@enact/ui/components/ui/zz-unused-export-probe";
EOF
...
EOF
cat >"$mention" <<'EOF'
// import { CommentProbe } from "@enact/ui/components/ui/zz-comment-probe";
const note = 'import { CommentProbe } from "@enact/ui/components/ui/zz-comment-probe"';
