...
// Because Enact has to take over HERMES_HOME to inject bound skills, that
...
//
//	<enact profile dir>/hermes-sessions/<agent>/<hermes profile>/<conversation>/state.db
//
...
// hermesSessionStoreRoot is the directory under the daemon's Enact profile
...
// on (neither an issue nor a chat session), or an unresolvable Enact profile
...
// publish.
const hermesSessionLinkStagingEntry = ".enact-session-link"
