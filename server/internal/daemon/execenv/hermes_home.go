...
//   - populates the task-local `skills/` dir with ONLY the Enact-bound skills,
...
//     Enact product concern — the host's local Hermes memory must not bleed
...
const hermesTaskLocalStateMarker = ".enact-task-local-state-v1"
...
// Enact-bound skills. They keep their natural slug (no user skills share this
