...
func TestHermesMemoryStorePathLayout(t *testing.T) {
	...
	want := filepath.Join(home, ".enact", hermesMemoryStoreRoot, agent, "research")
	if got != want {
...
func TestPruneHermesMemoryStores(t *testing.T) {
	...
	root := filepath.Join(home, ".enact", hermesMemoryStoreRoot)
...
func TestPruneHermesMemoryStoresDisabled(t *testing.T) {
	...
	store := filepath.Join(home, ".enact", hermesMemoryStoreRoot, "agent-1", "default")
