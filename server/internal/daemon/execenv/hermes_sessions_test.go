...
func TestHermesSessionStorePathLayout(t *testing.T) {
	...
	want := filepath.Join(home, ".enact", hermesSessionStoreRoot, agent, "research", issue)
	if got != want {
...
func TestPruneHermesSessionStores(t *testing.T) {
	...
	root := filepath.Join(home, ".enact", hermesSessionStoreRoot)
...
func TestPruneHermesSessionStoresDisabled(t *testing.T) {
	...
	store := filepath.Join(home, ".enact", hermesSessionStoreRoot, "agent-1", "default", "issue-1")
