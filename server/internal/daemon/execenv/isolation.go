...
// in the enact binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__enact_execenv_prepare"
...
// name the current enact binary followed by PreparationHelperArg in
