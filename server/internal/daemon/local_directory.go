...
// sibling checkouts ("NuvioTV" vs "enact") without naming their parent.
...
// stamping context files (.agent_context/, .claude/skills/, .enact/) at
...
func checkDirReadWrite(dir string) error {
	...
	probe, err := os.CreateTemp(dir, ".enact-rwcheck-*")
	if err != nil {
