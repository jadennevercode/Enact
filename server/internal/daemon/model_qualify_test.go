...
func thinkingCatalogs() map[string]agent.Catalog {
	gatewayOpus := agent.Model{
		ID:       "enact-anthropic/claude/claude-opus-5",
		Provider: "enact-anthropic",
...
func TestResolveTaskModelSelectionReadsTheCatalogAtMostOnce(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want:      taskModelSelection{Model: "enact-anthropic/claude/claude-opus-5", ThinkingLevel: "high"},
			wantReads: 1,
		},
		{
		...
		},
		{
			...
			provider:  "opencode",
			in:        taskModelSelection{Model: "claude/claude-opus-5"},
			want:      taskModelSelection{Model: "enact-anthropic/claude/claude-opus-5"},
			wantReads: 1,
		},
		{
