...
const (
	StartupTimeoutEnv = "ENACT_DATABASE_STARTUP_TIMEOUT"
	ConnectTimeoutEnv = "ENACT_DATABASE_CONNECT_TIMEOUT"
	...
	startupStartedAtEnv = "ENACT_INTERNAL_DATABASE_STARTUP_STARTED_AT_UNIX"
