...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.enact.ai"
	cookieDomain string // cookie scope, e.g. ".enact.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.enact.ai")
//   - COOKIE_DOMAIN           (e.g. ".enact.ai")
