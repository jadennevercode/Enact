...
// https://enact.ai/docs/community-maintained
...
// file. `enact attachment upload` returns once the object is in storage and
...
type Installation struct {
	...
	// mention arrives as literal text — "@Enact Bot /new 重新分析" — with no
