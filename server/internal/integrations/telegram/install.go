...
// its token into Enact. The InstallService owns the at-rest encryption of
...
var (
	...
	// ErrCredentialsUnverifiable means Enact could not complete the live
	...
	// live owner in a DIFFERENT Enact workspace.
	ErrBotOwnedByAnotherWorkspace = errors.New("telegram: this bot is already connected to a different Enact workspace")
...
// chat sessions stay in Enact. The Supervisor stops supervising the
