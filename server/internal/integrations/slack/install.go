...
var (
	...
	// already connected to a live owner in a DIFFERENT Enact workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Enact workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Enact
