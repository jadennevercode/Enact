...
//     and an expiry. Enact renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Enact. Empty defaults
	// to "enact".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Enact's `source`
...
// cannot attribute installs back to Enact in their analytics.
//
