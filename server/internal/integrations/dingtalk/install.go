...
// (client secret) into Enact (the paste path lives in byo_install.go). The
...
var (
	...
	// is already connected to a live owner in a DIFFERENT Enact workspace — it
	...
	ErrRobotOwnedByAnotherWorkspace = errors.New("dingtalk: this DingTalk robot is already connected to a different Enact workspace")
