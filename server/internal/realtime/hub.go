...
// loadTrustedProxies reads the same ENACT_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("ENACT_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared ENACT_TRUSTED_PROXIES value in here at startup.
