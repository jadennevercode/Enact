...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"empty origin allowed", "api.enact.ai", "", "", "1.2.3.4:5678", true},
		...
		{"X-Forwarded-Host from trusted proxy case-insensitive", "internal.proxy", "https://Enact.AI", "enact.ai", "10.0.0.1:5678", true},
		{"X-Forwarded-Host from untrusted source rejected", "internal.proxy", "https://example.com", "example.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted proxy but evil origin rejected", "internal.proxy", "https://evil.com", "enact.ai", "127.0.0.1:5678", false},
		{"X-Forwarded-Host present but origin matches direct Host", "enact.ai", "https://enact.ai", "other.host", "1.2.3.4:5678", true},
		{"X-Forwarded-Host spoofed by attacker rejected", "internal.proxy", "https://evil.com", "evil.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted CIDR range matches origin", "internal.proxy", "https://enact.ai", "enact.ai", "10.5.6.7:5678", true},
		{"X-Forwarded-Host from trusted IPv6 proxy matches origin", "internal.proxy", "https://enact.ai", "enact.ai", "[::1]:5678", true},
		{"X-Forwarded-Host comma list uses first (client-facing) value", "internal.proxy", "https://enact.ai", "enact.ai, proxy.internal", "127.0.0.1:5678", true},
		{"X-Forwarded-Host comma list ignores trailing values", "internal.proxy", "https://staging.enact.ai", "proxy.internal, staging.enact.ai", "127.0.0.1:5678", false},
	}
