...
const (
	invitationActorLimiterKeyPrefix     = "enact:invitation:actor:"
	invitationWorkspaceLimiterKeyPrefix = "enact:invitation:workspace:"
	invitationRecipientLimiterKeyPrefix = "enact:invitation:recipient:"
)
