...
func (h *Handler) RegisterSemanticRoutes(r chi.Router) {
	r.Route("/api/semantic", func(r chi.Router) {
		...
		h.registerSemanticReviewRoutes(r)
		r.Get("/agents/{agentID}/ontologies", h.semanticAgentOntologies)
		r.Put("/agents/{agentID}/ontologies", h.semanticAssignAgentOntologies)
		...
		r.Post("/ontologies/{id}/context", h.semanticDraftContext)
		r.Post("/ontologies/{id}/evaluate", h.semanticDraftEvaluate)
		r.Post("/ontologies/{id}/policies", h.semanticDraftPolicies)
		r.Get("/ontologies/{id}/policy-tests", h.semanticDraftPolicyTests)
		...
		r.Post("/releases/{id}/install-preview", h.semanticPreviewReleaseInstall)
		r.Post("/releases/{id}/install", h.semanticInstallRelease)
		...
		r.Post("/runs/{id}/context", h.semanticBusinessContext)
		r.Post("/runs/{id}/plan", h.semanticSavePlan)
		r.Get("/runs/{id}/plan", h.semanticGetPlan)
		r.Post("/runs/{id}/policies", h.semanticEvaluatePolicies)
		r.Post("/runs/{id}/report", h.semanticSaveReport)
		r.Get("/runs/{id}/report", h.semanticGetBusinessReport)
