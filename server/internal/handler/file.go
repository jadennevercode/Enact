...
type AttachmentResponse struct {
	...
	// ENACT_LOCAL_UPLOAD_BASE_URL), and otherwise prefixing
	// ENACT_PUBLIC_URL onto the stable per-attachment endpoint that the
...
//     proxies on every request, anchored on `ENACT_PUBLIC_URL` so the
