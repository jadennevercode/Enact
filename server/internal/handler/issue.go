...
// translates the prompt into a `enact issue create` invocation in the
...
// metadata column is JSONB on the wire; the daemon stores the enact CLI
...
func (h *Handler) BatchUpdateIssues(w http.ResponseWriter, r *http.Request) {
	...
	// count match reality. See enact-ai/enact#1660.
