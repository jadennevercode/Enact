...
// emitted via the X-Enact-Next-Before / X-Enact-Next-Before-Id
// response headers.
//
...
func (h *Handler) ListComments(w http.ResponseWriter, r *http.Request) {
	...
	if result.NextBefore != "" && result.NextBeforeID != "" {
		w.Header().Set("X-Enact-Next-Before", result.NextBefore)
		w.Header().Set("X-Enact-Next-Before-Id", result.NextBeforeID)
	}
