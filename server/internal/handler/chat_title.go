...
// acceptance criteria in ENA-4295: no quotes, no trailing punctuation, no
...
// Chinese pills for English conversations (ENA-5689). The label prefixes this
...
//
// Design constraints from ENA-4295:
...
func (h *Handler) maybeGenerateChatTitleAsync(workspaceID, userID string, sessionID pgtype.UUID, currentTitle, sourceText string) {
	...
	// (self-hosted without ENACT_LLM_API_KEY / ENACT_LLM_BASE_URL): the
...
func (h *Handler) generateChatSessionTitle(ctx context.Context, sessionID pgtype.UUID, currentTitle, sourceText string) (db.ChatSession, bool, error) {
	...
	// deployment configures ENACT_LLM_DEFAULT_MODEL (or the built-in
