...
func TestAutopilotCollaborator_GrantedMemberCanWrite(t *testing.T) {
	...
	member := createPlainMember(t, "ap-collab-grantee@enact.test")
...
func TestAutopilotCollaborator_NonWriterCannotGrant(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-collab-stranger@enact.test")
	victim := createPlainMember(t, "ap-collab-victim@enact.test")
...
func TestAutopilotCollaborator_CannotManageAccessList(t *testing.T) {
	...
	carol := createPlainMember(t, "ap-collab-carol@enact.test")
	dave := createPlainMember(t, "ap-collab-dave@enact.test")
	bob := createPlainMember(t, "ap-collab-bob2@enact.test")
...
func TestAutopilotWrite_PlainMemberCannotMutateOthers(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-stranger@enact.test")
...
func TestAutopilotWrite_CreatorCanMutateOwn(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-creator@enact.test")
...
func TestAutopilotWrite_AdminCanMutateMembersAutopilot(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-admin-target@enact.test")
...
func TestAutopilotWrite_WebhookSecretRedactedForNonWriter(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-perm-secret-stranger@enact.test")
