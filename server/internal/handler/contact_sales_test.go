...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@enact.ai", "ada@enact.ai", true},
		{"uppercase normalized", "Ada@Enact.AI", "ada@enact.ai", true},
		{"trim whitespace", "  ada@enact.ai  ", "ada@enact.ai", true},
		{"display name stripped", "Ada Lovelace <ada@enact.ai>", "ada@enact.ai", true},
		{"angle-bracketed", "<ada@enact.ai>", "ada@enact.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@enact.ai", "", false},
