...
func (h *Handler) revokeAndRemoveMember(ctx context.Context, workspaceID, userID, memberID, archivedBy pgtype.UUID) (revocationResult, error) {
	...
	// paths cannot deadlock against each other (ENA-5483 review round 7).
	...
	// a removed member's IM bindings vanished automatically. ENA-3515 §4 dropped
	...
	// (ENA-3963 keeps the new table FK-free, matching the ENA-3515 channel
