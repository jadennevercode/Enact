...
func TestAgentEnv_AgentOwnerMemberCanRevealAndUpdate(t *testing.T) {
	...
	agentID, ownerUserID := agentEnvOwnerFixture(t, "env-owner-member-agent", "env-owner-member@enact.test")
...
func TestAgentEnv_UnrelatedMemberForbidden(t *testing.T) {
	...
	agentID, _ := agentEnvOwnerFixture(t, "env-unrelated-target-agent", "env-target-owner@enact.test")
	strangerID := createPermissionTestMember(t, "env-stranger@enact.test")
...
func TestAgentEnv_WorkspaceRolesUnchanged(t *testing.T) {
	...
	agentID, _ := agentEnvOwnerFixture(t, "env-role-check-agent", "env-role-check-owner@enact.test")

	adminID := createPermissionTestMember(t, "env-admin@enact.test")
...
func TestAgentEnv_AgentActorRejectedForOwnedAgent(t *testing.T) {
	...
	targetID, ownerUserID := agentEnvOwnerFixture(t, "env-actor-target-agent", "env-actor-owner@enact.test")
