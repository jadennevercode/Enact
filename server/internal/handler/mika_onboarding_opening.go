...
// than generated by an agent run (ENA-5827).
//
...
// decision. The enact-onboarding skill already pinned it to four beats under
...
var mikaOnboardingOpenings = map[string]string{
	"en": `Hi — welcome to %[1]s. Enact is a workspace where you and AI agents coordinate real work through issues.
...
Pick one below, or just tell me what you want to get done right now.`,
	...
	"zh": `你好，欢迎来到 %[1]s。Enact 是一个人和 AI 智能体通过任务一起把事情做完的工作区。
...
从下面选一个开始，或者直接告诉我你现在想做成什么。`,
	...
	"ja": `こんにちは。%[1]s へようこそ。Enact は、人と AI エージェントがタスクを通じて実際の仕事を進めるワークスペースです。
...
下から一つ選ぶか、いま進めたいことをそのまま教えてください。`,
	...
	"ko": `안녕하세요, %[1]s에 오신 걸 환영합니다. Enact는 사람과 AI 에이전트가 태스크를 통해 실제 일을 함께 진행하는 워크스페이스입니다.
