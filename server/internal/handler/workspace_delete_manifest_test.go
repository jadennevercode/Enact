...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"semantic_draft_policy_test_result": workspaceDelete,
	"semantic_connection":               workspaceDelete,
	"semantic_ontology":                 workspaceDelete,
	"semantic_release_installation":     workspaceDelete,
	...
	"marketplace_install":                 workspaceDelete,
	"marketplace_listing":                 workspaceDelete,
	"marketplace_listing_file":            workspaceDelete,
	"marketplace_listing_version":         workspaceDelete,
	"marketplace_recommendation_decision": workspaceDelete,
	...
	"workspace_resource":                  workspaceDelete,
