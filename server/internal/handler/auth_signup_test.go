...
func TestSignupGating(t *testing.T) {
	tests := []struct {
		...
		{"required_domain_hk", Config{AllowSignup: true}, "a@deloitte.com.hk", true, false},
		{"required_domain_hk_mixed_case", Config{AllowSignup: true}, "a@Deloitte.COM.hk", true, false},
		{"required_domain_hk_suffix_only", Config{AllowSignup: true}, "a@notdeloitte.com.hk", true, true},
