...
This skill states WHAT a mention link does in the Enact backend, traced to
...
Correct:
  1. `enact workspace member list --output json`  → Alice's `user_id` = 7f3a…
