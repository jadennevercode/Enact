...
This file records source evidence for `enact-squads/SKILL.md`.
...
```bash
enact squad list
enact squad get <squad-id>
enact squad create
enact squad update <squad-id>
enact squad delete <squad-id>
enact squad activity <issue-id> <outcome>

enact squad member list <squad-id>
enact squad member add <squad-id>
enact squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin enact-* skills are excluded and human
