-- Add a per-installation `region` so one Enact deployment can serve
...
-- deployment-wide value (the ENACT_LARK_HTTP_BASE_URL /
-- ENACT_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
