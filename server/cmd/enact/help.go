...
var rootHelpTemplate = `Work seamlessly with Enact from the command line.

USAGE
  enact <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
ENVIRONMENT VARIABLES
  ENACT_SERVER_URL    Override the default server URL
  ENACT_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`enact <command> <subcommand> --help`" + ` for more information about a command.
`
