...
// Tests for `enact issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue enact-ai/enact#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `enact issue metadata list <issue> --output json`
