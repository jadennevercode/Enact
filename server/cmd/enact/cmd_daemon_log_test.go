...
func TestNewDaemonLogRotatorDefaults(t *testing.T) {
	os.Unsetenv("ENACT_DAEMON_LOG_MAX_SIZE_MB")
	os.Unsetenv("ENACT_DAEMON_LOG_MAX_BACKUPS")
	os.Unsetenv("ENACT_DAEMON_LOG_MAX_AGE_DAYS")
...
func TestNewDaemonLogRotatorEnvOverride(t *testing.T) {
	t.Setenv("ENACT_DAEMON_LOG_MAX_SIZE_MB", "5")
	t.Setenv("ENACT_DAEMON_LOG_MAX_BACKUPS", "2")
	t.Setenv("ENACT_DAEMON_LOG_MAX_AGE_DAYS", "7")
...
// stays bounded (the core of ENA-4330). Uses the 1 MB floor lumberjack enforces.
func TestDaemonLogRotatorRotates(t *testing.T) {
	t.Setenv("ENACT_DAEMON_LOG_MAX_SIZE_MB", "1")
	t.Setenv("ENACT_DAEMON_LOG_MAX_BACKUPS", "3")
