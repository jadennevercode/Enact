...
// O(1); the fanout was O(workspace connections × description size) (ENA-5492).
//
...
// horizontal-scaling plan tracked in ENA-1138.
func registerListeners(bus *events.Bus, b realtime.Broadcaster) {
	...
	bus.SubscribeAll(func(e events.Event) {
		...
		// Phase 1 (ENA-1138): the per-resource scope routing for high-frequency
