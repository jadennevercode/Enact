...
// `my-plugin/enact.plugin.json`. One leading directory is accepted; the
...
func TestParseBundleRejections(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			files: map[string]string{
				plugincontract.ManifestFilename: bundleManifest,
				"ui/main.js":                    "import { enact } from \"https://esm.sh/@enact/plugin-sdk@1\";\n",
				"skills/pr-review/SKILL.md":     "Read the diff.\n",
			},
...
func TestSurfaceEntryModuleDetection(t *testing.T) {
	refused := map[string]string{
		"bare import":                    "import { enact } from \"./sdk.js\";\n",
		"indented import":                "  import { enact } from \"./sdk.js\";\n",
		"import after a line comment":    "// set up\nimport { enact } from \"./sdk.js\";\n",
		"import after a block comment":   "/* set up */ import { enact } from \"./sdk.js\";\n",
