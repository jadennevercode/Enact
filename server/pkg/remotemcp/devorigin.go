...
//
// The `http` transport already has this: ENACT_PLUGIN_DEV_ORIGINS names exact
...
const DevOriginsEnv = "ENACT_PLUGIN_DEV_ORIGINS"
...
const DevCAEnv = "ENACT_PLUGIN_DEV_CA"
