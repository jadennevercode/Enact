...
func TestBuildAuthorizationURLPinsPKCEStateAndResource(t *testing.T) {
	...
	got, err := BuildAuthorizationURL(metadata, registration, "https://enact.example/api/callback", "state-1", "verifier-1", "search read")
	if err != nil {
		t.Fatal(err)
	}
	...
	checks := map[string]string{
		...
		"response_type":         "code",
		"client_id":             "client-1",
		"redirect_uri":          "https://enact.example/api/callback",
		"state":                 "state-1",
