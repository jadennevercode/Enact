...
const (
	opencodeStdinHelperEnv      = "ENACT_OPENCODE_STDIN_HELPER"
	opencodeStdinHelperArgvFile = "ENACT_OPENCODE_STDIN_HELPER_ARGV_FILE"
	opencodeStdinHelperInFile   = "ENACT_OPENCODE_STDIN_HELPER_STDIN_FILE"
)
