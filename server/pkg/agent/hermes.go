...
// file write on the Hermes ACP runtime (GitHub enact#5300).
...
// GitHub enact#5300 it refuses to auto-select a permanent "allow_always"
...
// even when Enact did not pass an explicit agent.model override.
...
// files use instead of Enact's canonical `mcpServers`: jcode and Kiro
...
// enact#5862 — do not gate matching on length).
