...
not import any other Enact package, so it can be reused by other services or
...
import (
    ...
    "github.com/enact-ai/enact/server/pkg/composio"
)
...
link, err := client.CreateLink(ctx, composio.CreateLinkRequest{
    ...
    UserID:       enactUserID.String(), // your own user id
    CallbackURL:  "https://enact.ai/api/integrations/composio/callback",
})
...
- **Standalone.** Zero coupling to Enact internals — depend on this package
